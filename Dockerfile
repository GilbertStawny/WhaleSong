...
RUN yum install -y tcpdump traceroute telnet unicornscan bind-utils iperf3 net-tools dhcping ethtool mtr openssl iftop wget openssh-server iproute nmap java nginx
